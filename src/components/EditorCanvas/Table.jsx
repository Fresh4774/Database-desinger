    ...
    <>
      ...
      >
        <div
          ...
          className={`border-2 hover:border-dashed hover:border-ed-500
                          ...
                          <div>
                            {tableData.indices.map((index, k) => (
                              ...
                              >
                                ...
                                <div>
                                  {index.fields.map((f) => (
                                    <Tag color="red" key={f} className="me-1">
                                      {f}
                                    </Tag>
                                  ))}
                                </div>
              ...
              <Popover
                ...
                content={
                  <div className="popover-theme">
                    ...
                    <hr />
                    {e.primary && (
                      <Tag color="red" className="me-2 my-2">
                        {t("primary")}
                      </Tag>
                    )}
                    {e.unique && (
  ...
  function field(fieldData, index) {
    return (
      ...
      >
        ...
        >
          <button
            className="flex-shrink-0 w-[10px] h-[10px] bg-[#FF1E00] rounded-full"
            onMouseDown={() => {
